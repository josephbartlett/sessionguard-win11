...
The tag must match the version in [`Directory.Build.props`](Directory.Build.props), and the matching release notes file must exist under [`docs/releases`](docs/releases), for example [`docs/releases/v1.1.0.md`](docs/releases/v1.1.0.md).
