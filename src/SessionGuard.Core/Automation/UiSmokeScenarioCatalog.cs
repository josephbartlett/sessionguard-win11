    ...
    private static UiSmokeScenario CreateSafeServiceScenario()
    {
        ...
        return new UiSmokeScenario(
            ...
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                [UiSmokeAutomationIds.ServiceActionAvailabilityText] = "Managed actions: monitoring is connected, but protection changes need an elevated SessionGuard window.",
