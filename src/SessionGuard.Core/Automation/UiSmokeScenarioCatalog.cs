    ...
    private static UiSmokeScenario CreateSafeServiceScenario()
    {
        ...
        return new UiSmokeScenario(
            ...
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                [UiSmokeAutomationIds.ServiceActionAvailabilityText] = "Managed actions: the service is connected, but this app session is not elevated. Run SessionGuard.App as administrator to change guard mode, protections, or approval state.",
