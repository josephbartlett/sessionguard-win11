...
public static class UiSmokeAutomationIds
{
    public const string MainWindow = "SessionGuardMainWindow";
    public const string CurrentStatusText = "CurrentStatusText";
    public const string RestartRiskText = "RestartRiskText";
    public const string ProtectionModeText = "ProtectionModeText";
    public const string PendingRestartText = "PendingRestartText";
    ...
    public const string PolicyTimingText = "PolicyTimingText";
